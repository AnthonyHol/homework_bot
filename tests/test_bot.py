...
class TestHomework:
    ...
    def test_get_api_answers(
        ...
        assert type(result) == dict, (
            f"Проверьте, что из функции `{func_name}` " "возвращается словарь"
        )
    ...
    def test_parse_status_unknown_status(
        self, monkeypatch, random_timestamp, current_timestamp, api_url
    ):
        def mock_response_get(*args, **kwargs):
            response = MockResponseGET(
    ...
    def test_parse_status_no_status_key(
        self, monkeypatch, random_timestamp, current_timestamp, api_url
    ):
        def mock_response_get(*args, **kwargs):
            response = MockResponseGET(
    ...
    def test_check_response_no_homeworks(
        self, monkeypatch, random_timestamp, current_timestamp, api_url
    ):
        def mock_no_homeworks_response_get(*args, **kwargs):
            ...
            def json_invalid():
                data = {"current_date": random_timestamp}
                return data
    ...
    def test_check_response_not_dict(
        self, monkeypatch, random_timestamp, current_timestamp, api_url
    ):
        def mock_response_get(*args, **kwargs):
            response = MockResponseGET(
